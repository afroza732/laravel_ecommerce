    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/add-manufacturer')}}">
                        <i class="fas fa-pen"></i>
                        <span>Add Manufacturer</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/manage-manufacturer')}}">
                        <i class="fas fa-pen"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/manage-product')}}">
                        <i class="fas fa-product-hunt"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/manage-slider')}}">
                        <i class="fas fa-product-hunt"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/social-link')}}">
                        <i class="fas fa-fw fa-chart-area"></i>
